...
// WICHTIG: Namespace muss "SortAlgorithms" sein
namespace SortAlgorithms
{
    // Entferne den anonymen Namespace, damit die Funktionen global im Projekt sichtbar sind
    ...
    // Die öffentliche Schnittstelle muss genau wie im Header deklariert sein
